...
export const merchant_account_info = (merchant_account_info: string, merchant_gui: string, merchant_key: string, merchant_gui_url: string, seller_key: string): string => {

	const result = `${merchant_gui}${merchant_gui_url.length}${merchant_gui_url}${merchant_key}${seller_key.length}${seller_key}`;
...
export const additional_field = (id_additional_field: string, id_tx_id: string, value: string): string => {
